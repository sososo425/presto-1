        ...
        implements JoinOperatorFactory, AdapterWorkProcessorOperatorFactory
{
    ...
    @Override
    public WorkProcessorOperator create(Session session, ProcessorContext processorContext, WorkProcessor<Page> sourcePages)
    {
    ...
    @Override
    public AdapterWorkProcessorOperator create(Session session, ProcessorContext processorContext)
    {
        LookupSourceFactory lookupSourceFactory = joinBridgeManager.getJoinBridge(processorContext.getLifespan());
