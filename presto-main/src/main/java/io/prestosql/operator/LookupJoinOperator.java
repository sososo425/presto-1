        ...
        implements AdapterWorkProcessorOperator
{
    ...
    public LookupJoinOperator(List<Type> probeTypes,
            ...
            WorkProcessorOperatorAdapter.ProcessorContext processorContext,
    ...
    private class JoinProcessor
            implements Transformation<Page, Page>, Closeable
    {
        ...
        public TransformationState<Page> process(@Nullable Page element)
        {
            ...
            if (!isBlocked().isDone()) {
                return TransformationState.blocked(isBlocked());
            }
            addInput(element);
            ...
            return TransformationState.ofResult(outputPage, needsInput());
        }
