        ...
        implements ConnectorPageSink
{
            ...
            KuduTableMapping mapping)
    {
        ...
        try {
            System.out.println("!!! " + this.generateUUID + " " + table.getPartitionSchema() + " " + table.getRangePartitions(100L) + " " + table.getName() + " " + table.getSchema().getColumns());
        }
        catch (Exception e) {
            e.printStackTrace();
        }
