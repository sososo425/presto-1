...
public class TestName
{
    ...
    @Test
    public void testCaseNormalizedName()
    {
        assertEquals(new Name("test", true).getCaseNormalizedName(), "test");
        assertEquals(new Name("test", false).getCaseNormalizedName(), "TEST");
        assertEquals(new Name("Test", true).getCaseNormalizedName(), "Test");
        assertEquals(new Name("Test", false).getCaseNormalizedName(), "TEST");
    }
    ...
    public void testNameEquivalence()
    {
        ...
        assertTrue(equivalentNames(new Name("test", true), new Name("Test", false)));
        assertTrue(equivalentNames(new Name("test", false), new Name("Test", true)));
        assertFalse(equivalentNames(new Name("test", true), new Name("Test", true)));
